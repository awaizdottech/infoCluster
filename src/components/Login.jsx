...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center grow justify-center exo">
      ...
      <form
        ...
        className="bg-[#242629] flex flex-col rounded-xl p-16 max-md:px-6"
      >
        <Input
          type="email"
          label="Email:"
        ...
        />
        <Input
          className="rounded-l-lg text-black my-3"
          label="Password:"
          ...
          button={
            <button
              ...
              className="bg-white text-black rounded-r-lg pe-1"
            >
              {showPassword ? (
                <svg
